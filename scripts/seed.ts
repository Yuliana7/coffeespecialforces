...
const seed = async () => {
  ...
  if (existingUsers.totalDocs === 0) {
    ...
    payload.logger.info(`Created admin user: ${username}`);
  } else {
  ...
  const createLocalized = async <
    T extends "projects" | "events" | "work-areas" | "locations",
  >(
    collection: T,
  ...
  const projectDefinitions = [
    ...
    },
    {
      uk: {
        ...
        location: kyiv.id,
        summary:
          "Закрито за 51 день. Генератор працює у операційній з березня.",
        content: richTextFrom([
    ...
    },
    {
      uk: {
        ...
        summary:
          "Півтонни свіжообсмаженої кави та 40 турок відправлені на позиції.",
        content: richTextFrom([
      ...
      en: {
        ...
        status: "completed",
        summary:
          "Half a tonne of freshly roasted coffee and 40 pots delivered to positions.",
        content: richTextFrom([
  ...
  const eventDefinitions = [
    ...
    },
    {
      uk: {
        ...
        location: kyiv.id,
        summary:
          "Восьмигодинний курс для цивільних. Безкоштовно, за попереднім записом.",
        content: richTextFrom([
      ...
      en: {
        ...
        summary:
          "An eight-hour course for civilians. Free, registration required.",
        content: richTextFrom([
    ...
    },
    {
      ...
      en: {
        ...
        content: richTextFrom([
          "The auction is over. The proceeds went towards first aid kits.",
        ]),
      },
    },
  ];
  ...
  const globals = [
      ...
      uk: {
        ...
        methods: [
          ...
          },
          {
            label: "PayPal",
            url: "https://paypal.me/",
            description: "Для донатів з-за кордону",
          },
        ],
      ...
      en: {
        ...
        methods: [
          ...
          },
          {
            label: "PayPal",
            url: "https://paypal.me/",
            description: "For donations from abroad",
          },
        ],
    ...
    },
    {
      ...
      uk: {
        ...
        legalName:
          "Благодійна організація «Благодійний фонд “Кава Спецпризначення”»",
